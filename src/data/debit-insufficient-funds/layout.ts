...
const BG_HEIGHT = 1760 // covers 10 steps + header + padding
...
const FLOW_NODES: Node[] = [
  ...
  // ── Return path (yellow) ───────────────────────────────────────────────────
  {
    id: 'debit-network-return',
    type: 'paymentNode',
    position: { x: NODE_X.network, y: Y(7) },
    data: { label: 'Decline Response', sublabel: 'Code 51 routed back via Star network', stepIndex: 7, icon: 'network', timing: '~200–500ms' },
  },
  {
    id: 'stripe-api-return',
    type: 'paymentNode',
    position: { x: NODE_X.stripe, y: Y(8) },
    data: { label: 'Decline Forwarded', sublabel: 'Stripe relays decline to browser', stepIndex: 8, icon: 'server', timing: '~instant' },
  },
  {
    id: 'customer-return',
    type: 'paymentNode',
    position: { x: NODE_X.customer, y: Y(9) },
    data: { label: 'Insufficient Funds', sublabel: 'Error surfaced to cardholder', stepIndex: 9, icon: 'monitor', timing: '~instant' },
  },
]
...
export const EDGES: Edge[] = [
  ...
  { id: 'e6-7', source: 'balance-check',        target: 'debit-network-return', label: 'decline code 51' },
  { id: 'e7-8', source: 'debit-network-return', target: 'stripe-api-return',   label: 'decline response' },
  { id: 'e8-9', source: 'stripe-api-return',    target: 'customer-return',     label: 'insufficient_funds' },
]
